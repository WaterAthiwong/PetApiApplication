...
@Service
class EndingMatCodeComposer: FinishedGoodMatCodeComposer {
    override fun compose(query: FinishedGoodMatCodeQuery): String {
        ...
        return "5${query.skuGroupCode}${species}${fsc}-${dimension}-${query.flooringAccessories}${query.texture}-${color}"
    }
}