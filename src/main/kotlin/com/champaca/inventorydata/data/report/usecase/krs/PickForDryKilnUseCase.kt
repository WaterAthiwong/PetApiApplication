...
class PickForDryKilnUseCase(
    ...
    companion object {
        const val DRY_KILN_DEPARTMENT_ID = 3
    ...
    fun execute(pickDateFrom: String, pickDateTo: String): File {
        ...
        transaction {
            ...
            val request = GetPileTransactionRequest(
                departmentId = DRY_KILN_DEPARTMENT_ID,
            ...
            transactions = transactionService.getPileTransaction(request, true)
        ...
        val fileName = "${dirName}/PickForDryKiln_${dateTimeUtil.getCurrentDateTimeString("yyyy_MM_dd_HH_mm")}.xlsx"
        workbook {
